...
per project is the highest-`version` entry. `session-notes/` lives at the portfolio root, outside
the repos and untracked, so the manifest is regenerated by scanning; it is never hand-edited.
