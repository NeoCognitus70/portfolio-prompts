...
| [`check-library.py`](check-library.py) | The library's **self-gate**: registry rows map to real folders, no unclassified workspace repo, README table is generated, internal doc links resolve, universal working norms stay centralised, and the worklist example parses. | PP-15, PP-17 |
