...
| `hand-baked-screenplay-pattern` | NeoCognitus70/hand-baked-screenplay-pattern | Active | Showcase | Active provider-first iteration. Provider-switching Phases 0-1 were promoted on 2026-08-16 as six required MEDIUM backlog items, HBSP-28..33, executed in dependency order. Calculator Phase 2 and later portfolio migrations remain unpromoted in their owning projects. Gates: `npm run verify`. |
