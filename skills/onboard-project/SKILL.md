...
argument-hint: "<project-folder> [GITHUB=<owner/repo>] [PORTFOLIO_ROOT=<path>]"
---

Onboard one existing local repository into the portfolio through staged, user-approved PRs.

Read and follow the canonical prompt **`${CLAUDE_PLUGIN_ROOT}/onboard-project.prompt.md`** (bundled
